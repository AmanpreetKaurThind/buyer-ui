...
app.get('/api/supported', async (req, res) => {
    try {
        const response = await axios.get('http://45.140.188.129:6533/api/adlinks/supported');
...
app.get('/api/bypass', async (req, res) => {
  try {
    ...
    const response = await axios.get(`http://45.140.188.129:6533/api/adlinks/bypass?url=${link}`);
